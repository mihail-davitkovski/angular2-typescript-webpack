...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_of__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_observable_of__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_observable_fromPromise__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_util_isPromise__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_util_isPromise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_util_isPromise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_operator_concatMap__ = __webpack_require__(93);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_operator_delay__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_operator_delay___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_rxjs_operator_delay__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_operator_first__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__http_status_codes__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__interfaces__ = __webpack_require__(54);
...
var BackendService = (function () {
    ...
    Object.defineProperty(BackendService.prototype, "dbReady", {
        ...
        get: function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_7_rxjs_operator_first__["first"].call(this.dbReadySubject.asObservable(), function (r) { return r; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    BackendService.prototype.handleRequest = function (req) {
        ...
        return __WEBPACK_IMPORTED_MODULE_5_rxjs_operator_concatMap__["concatMap"].call(this.dbReady, function () { return _this.handleRequest_(req); });
    };
    BackendService.prototype.handleRequest_ = function (req) {
        ...
        resOptions = this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].NOT_FOUND, "Collection '" + collectionName + "' not found");
    ...
    BackendService.prototype.addDelay = function (response) {
        ...
        return d === 0 ? response : __WEBPACK_IMPORTED_MODULE_6_rxjs_operator_delay__["delay"].call(response, d || 500);
    };
    /**
    ...
    BackendService.prototype.collectionHandler = function (reqInfo) {
        ...
        switch (reqInfo.method) {
            ...
            case 'delete':
                ...
                break;
            default:
                resOptions = this.createErrorResponseOptions(reqInfo.url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].METHOD_NOT_ALLOWED, 'Method not allowed');
                break;
        }
    ...
    BackendService.prototype.commands = function (reqInfo) {
        ...
        switch (command) {
            case 'resetdb':
                resOptions.status = __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].NO_CONTENT;
                return __WEBPACK_IMPORTED_MODULE_5_rxjs_operator_concatMap__["concatMap"].call(this.resetDb(reqInfo), function () { return _this.createResponse$(function () { return resOptions; }, false /* no latency delay */); });
            case 'config':
                if (method === 'get') {
                    resOptions.status = __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].OK;
                ...
                break;
            default:
                resOptions = this.createErrorResponseOptions(reqInfo.url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].INTERNAL_SERVER_ERROR, "Unknown command \"" + command + "\"");
        }
    ...
    BackendService.prototype.createResponseOptions$ = function (resOptionsFactory) {
        var _this = this;
        return new __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"](function (responseObserver) {
            var resOptions;
            try {
                ...
                resOptions = _this.createErrorResponseOptions('', __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].INTERNAL_SERVER_ERROR, "" + err);
            }
            var status = resOptions.status;
            try {
                resOptions.statusText = Object(__WEBPACK_IMPORTED_MODULE_8__http_status_codes__["c" /* getStatusText */])(status);
            }
            catch (e) { }
            if (Object(__WEBPACK_IMPORTED_MODULE_8__http_status_codes__["d" /* isSuccess */])(status)) {
    ...
    BackendService.prototype.delete = function (_a) {
        ...
        if (id == undefined) {
            return this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].NOT_FOUND, "Missing \"" + collectionName + "\" id");
        }
        var exists = this.removeById(collection, id);
        return {
            headers: headers,
            status: (exists || !this.config.delete404) ? __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].NO_CONTENT : __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].NOT_FOUND
        };
    };
    /**
    ...
    BackendService.prototype.get = function (_a) {
        ...
        if (!data) {
            return this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].NOT_FOUND, "'" + collectionName + "' with id='" + id + "' not found");
        }
        return {
            body: this.bodify(data),
            headers: headers,
            status: __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].OK
        };
    };
    /**
    ...
    BackendService.prototype.post = function (_a) {
        ...
        if (item.id == undefined) {
            try {
                ...
                if (/id type is non-numeric/.test(emsg)) {
                    return this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].UNPROCESSABLE_ENTRY, emsg);
                }
                else {
                    console.error(err);
                    return this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].INTERNAL_SERVER_ERROR, "Failed to generate new id for '" + collectionName + "'");
                }
            }
        }
        if (id && id !== item.id) {
            return this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].BAD_REQUEST, "Request id does not match item.id");
        }
        else {
            id = item.id;
        }
        ...
        if (existingIx === -1) {
            ...
            return { headers: headers, body: body, status: __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].CREATED };
        }
        else if (this.config.post409) {
            return this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].CONFLICT, "'" + collectionName + "' item with id='" + id + " exists and may not be updated with POST; use PUT instead.");
        }
        else {
            collection[existingIx] = item;
            return this.config.post204 ?
                { headers: headers, status: __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].NO_CONTENT } :
                { headers: headers, body: body, status: __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].OK }; // successful; return entity
        }
    };
    ...
    BackendService.prototype.put = function (_a) {
        ...
        if (id && id !== item.id) {
            return this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].BAD_REQUEST, "Request for '" + collectionName + "' id does not match item.id");
        }
        else {
            id = item.id;
        }
        ...
        if (existingIx > -1) {
            ...
            return this.createErrorResponseOptions(url, __WEBPACK_IMPORTED_MODULE_8__http_status_codes__["a" /* STATUS */].NOT_FOUND, "'" + collectionName + "' item with id='" + id + " not found and may not be created with PUT; use POST instead.");
        }
        else {
    ...
    BackendService.prototype.resetDb = function (reqInfo) {
        ...
        var db$ = db instanceof __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"] ? db :
            Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_util_isPromise__["isPromise"])(db) ? Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_observable_fromPromise__["fromPromise"])(db) :
                Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_observable_of__["of"])(db);
        __WEBPACK_IMPORTED_MODULE_7_rxjs_operator_first__["first"].call(db$).subscribe(function (d) {
            _this.db = d;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_tslib__ = __webpack_require__(40);
 ...
 * @deprecated use \@angular/common/http instead
 */
var VERSION = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["Version"]('5.0.1');
...
var LoginDataService = /** @class */ (function () {
    function LoginDataService(store) {
        this.store = store;
    }
    LoginDataService.prototype.isUserLoggedIn = function () {
        return this.store.select(function (appState) { return appState.login.email != null && appState.login.password != null; });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__http_status_codes__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__interfaces__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__backend_service__ = __webpack_require__(130);
...
var HttpBackendService = (function (_super) {
    ...
    HttpBackendService.prototype.createResponse$fromResponseOptions$ = function (resOptions$) {
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_operator_map__["map"].call(resOptions$, function (opts) {
...
var HttpClientBackendService = (function (_super) {
    ...
    HttpClientBackendService.prototype.createResponse$fromResponseOptions$ = function (resOptions$) {
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_operator_map__["map"].call(resOptions$, function (opts) { return new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["HttpResponse"](opts); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interfaces__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__http_backend_service__ = __webpack_require__(197);
////// Http-Only version ////
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interfaces__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__http_client_backend_service__ = __webpack_require__(198);
...
var core_1 = __webpack_require__(7);
var login_data_service_1 = __webpack_require__(137);
var LoginRouteGuard = /** @class */ (function () {
    function LoginRouteGuard(loginService, router) {
        var _this = this;
        this.loginService = loginService;
        this.router = router;
        this._canActivate = false;
        loginService.isUserLoggedIn().subscribe(function (value) {
            if (!value) {
    ...
    LoginRouteGuard = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [login_data_service_1.LoginDataService, router_1.Router])
    ], LoginRouteGuard);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(7);
var inventory_data_service_1 = __webpack_require__(349);
var inventory_actions_service_1 = __webpack_require__(350);
/**
 * @InventoryApp: the top-level component for our application
 */
var InventoryBoxComponent = /** @class */ (function () {
    function InventoryBoxComponent(inventoryDataService, inventoryActionsService) {
        var _this = this;
        this.inventoryDataService = inventoryDataService;
        this.inventoryActionsService = inventoryActionsService;
        this.inventoryDataService.getProducts().subscribe(function (products) {
            _this.products = products;
        });
    }
    InventoryBoxComponent.prototype.ngOnInit = function () {
    ...
    InventoryBoxComponent = __decorate([
        core_1.Component({
            ...
            providers: [inventory_data_service_1.InventoryDataService, inventory_actions_service_1.InventoryActionsService]
        }),
        __metadata("design:paramtypes", [inventory_data_service_1.InventoryDataService,
            inventory_actions_service_1.InventoryActionsService])
...
(function (InventoryActionType) {
    InventoryActionType[InventoryActionType["REQUEST_PRODUCTS_STARTED"] = 0] = "REQUEST_PRODUCTS_STARTED";
    InventoryActionType[InventoryActionType["RECEIVE_PRODUCTS_FINSIHED"] = 1] = "RECEIVE_PRODUCTS_FINSIHED";
})(InventoryActionType = exports.InventoryActionType || (exports.InventoryActionType = {}));
...
var login_actions_service_1 = __webpack_require__(363);
var login_data_service_1 = __webpack_require__(137);
var LoginComponent = /** @class */ (function () {
    function LoginComponent(loginActionService, loginDataService, builder) {
        ...
        loginDataService.isUserLoggedIn().subscribe(function (value) {
        });
    }
    ...
    LoginComponent = __decorate([
        core_1.Component({
            ...
            providers: [{ provide: login_actions_service_1.ILoginActionsService, useClass: login_actions_service_1.LoginActionsService }, login_data_service_1.LoginDataService]
        }),
        __metadata("design:paramtypes", [login_actions_service_1.ILoginActionsService,
            login_data_service_1.LoginDataService, forms_1.FormBuilder])
    ], LoginComponent);
...
var platform_browser_dynamic_1 = __webpack_require__(218);
...
var angular_in_memory_web_api_1 = __webpack_require__(342);
var app_routing_1 = __webpack_require__(344);
var core_module_1 = __webpack_require__(347);
var inventory_module_1 = __webpack_require__(348);
var root_reducer_1 = __webpack_require__(357);
var app_component_1 = __webpack_require__(360);
var login_module_1 = __webpack_require__(361);
var in_memory_data_service_1 = __webpack_require__(365);
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            imports: [
                ...
                store_1.StoreModule.forRoot(root_reducer_1.rootReducer),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__backend_service__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__http_status_codes__ = __webpack_require__(96);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__http_backend_service__ = __webpack_require__(197);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__in_memory_web_api_module__ = __webpack_require__(343);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__http_in_memory_web_api_module__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__http_client_in_memory_web_api_module__ = __webpack_require__(200);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__interfaces__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__http_in_memory_web_api_module__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__http_client_in_memory_web_api_module__ = __webpack_require__(200);
...
var login_route_guard_1 = __webpack_require__(212);
var core_1 = __webpack_require__(7);
...
var inventory_box_component_1 = __webpack_require__(213);
var products_list_component_1 = __webpack_require__(351);
var price_display_component_1 = __webpack_require__(352);
var product_image_component_1 = __webpack_require__(353);
var product_department_component_1 = __webpack_require__(354);
var product_row_component_1 = __webpack_require__(355);
var inventory_routing_1 = __webpack_require__(356);
...
var InventoryDataService = /** @class */ (function () {
    function InventoryDataService(store) {
        this.store = store;
    }
    InventoryDataService.prototype.getProducts = function () {
        return this.store.select(function (appState) { return appState.inventory.products; });
    };
    InventoryDataService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [store_1.Store])
    ], InventoryDataService);
    return InventoryDataService;
}());
exports.InventoryDataService = InventoryDataService;
...
var store_1 = __webpack_require__(66);
var http_1 = __webpack_require__(77);
var action_types_1 = __webpack_require__(214);
var action_creator_1 = __webpack_require__(215);
var InventoryActionsService = /** @class */ (function () {
    function InventoryActionsService(store, http) {
        this.store = store;
        this.http = http;
        this.productsUrl = 'api/products'; // URL to web api
    }
    InventoryActionsService.prototype.getAllProducts = function () {
        var _this = this;
        this.store.dispatch(action_creator_1.createAction(action_types_1.InventoryActionType.REQUEST_PRODUCTS_STARTED.toString()));
        this.http
            .get(this.productsUrl)
            .subscribe(function (data) {
            var products = data.results;
            _this.store.dispatch(action_creator_1.createAction(action_types_1.InventoryActionType.RECEIVE_PRODUCTS_FINSIHED.toString(), products));
        });
    };
    InventoryActionsService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [store_1.Store, http_1.HttpClient])
    ], InventoryActionsService);
    return InventoryActionsService;
}());
exports.InventoryActionsService = InventoryActionsService;
...
var login_route_guard_1 = __webpack_require__(212);
var inventoryRoutes = [
    { path: 'inventory', component: inventory_box_component_1.InventoryBoxComponent, canActivate: [login_route_guard_1.LoginRouteGuard] }
];
exports.routing = router_1.RouterModule.forChild(inventoryRoutes);
...
Object.defineProperty(exports, "__esModule", { value: true });
var login_reducer_1 = __webpack_require__(358);
var inventory_reducer_1 = __webpack_require__(359);
exports.rootReducer = {
    inventory: inventory_reducer_1.inventoryReducer,
    login: login_reducer_1.loginReducer
};
...
exports.loginReducer = function (state, action) {
    if (state === void 0) { state = defaultLoginState; }
    switch (action.type) {
        case "LOGIN_USER_SUCCESS":
            return __assign({}, state, { email: action.payload.email, password: action.payload.password, status: true });
        case "LOGIN_USER_ERROR":
            return __assign({}, state, { email: null, password: null });
        case "LOGOUT":
            return __assign({}, state, { email: null, password: null });
        default:
            return state;
...
Object.defineProperty(exports, "__esModule", { value: true });
var action_types_1 = __webpack_require__(214);
var defaultInventoryState = {
    isFetching: false,
    products: []
};
exports.inventoryReducer = function (state, action) {
    if (state === void 0) { state = defaultInventoryState; }
    switch (action.type) {
        case action_types_1.InventoryActionType.REQUEST_PRODUCTS_STARTED.toString():
            return __assign({}, state, { isFetching: true });
        case action_types_1.InventoryActionType.RECEIVE_PRODUCTS_FINSIHED.toString():
            return __assign({}, state, { isFetching: false, products: action.payload });
        default:
            return state;
    }
};
...
var core_1 = __webpack_require__(7);
var common_1 = __webpack_require__(52);
var login_component_1 = __webpack_require__(216);
var forms_1 = __webpack_require__(138);
var login_routing_1 = __webpack_require__(364);
var login_data_service_1 = __webpack_require__(137);
...
var store_1 = __webpack_require__(66);
var action_creator_1 = __webpack_require__(215);
var ILoginActionsService = /** @class */ (function () {
    function ILoginActionsService() {
    }
    return ILoginActionsService;
}());
exports.ILoginActionsService = ILoginActionsService;
var LoginActionsService = /** @class */ (function () {
    function LoginActionsService(store, router) {
        this.store = store;
        this.router = router;
    }
    LoginActionsService.prototype.login = function (credentials) {
        this.store.dispatch(action_creator_1.createAction("LOGIN_USER_PENDING"));
        if (credentials.email === 'user' && credentials.password === 'password') {
            this.store.dispatch(action_creator_1.createAction("LOGIN_USER_SUCCESS", credentials));
            this.router.navigate(['/inventory']);
        }
        else {
            this.store.dispatch(action_creator_1.createAction("LOGIN_USER_ERROR", credentials));
        }
    };
    LoginActionsService.prototype.logout = function () {
        this.store.dispatch(action_creator_1.createAction("LOGOUT_USER"));
    };
    LoginActionsService.LOGIN_USER_PENDING = 'LOGIN_USER_PENDING';
    LoginActionsService.LOGIN_USER_SUCCESS = 'LOGIN_USER_SUCCESS';
    LoginActionsService.LOGIN_USER_ERROR = 'LOGIN_USER_ERROR';
    LoginActionsService.LOGOUT_USER = 'LOGOUT_USER';
    LoginActionsService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [store_1.Store, router_1.Router])
    ], LoginActionsService);
    return LoginActionsService;
}());
exports.LoginActionsService = LoginActionsService;
...
exports.routing = router_1.RouterModule.forChild(signupRoutes);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_observable_of__ = __webpack_require__(78);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_operator_filter__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_tslib__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_common__ = __webpack_require__(52);
